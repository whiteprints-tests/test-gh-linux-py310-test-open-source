...
# test gh linux py310-test-open-source

![test gh linux py310-test-open-source banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        ...
        <a href="https://github.com/whiteprints-tests/test-gh-linux-py310-test-open-source/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-gh-linux-py310-test-open-source.svg?logo=GitHub"></a>
