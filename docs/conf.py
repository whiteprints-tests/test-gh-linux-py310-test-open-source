...
project = "test gh linux py310-test-open-source"
...
release = metadata.version("test_gh_linux_py310_test_open_source")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-gh-linux-py310-test-open-source",
