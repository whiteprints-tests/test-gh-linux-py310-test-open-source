...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-gh-linux-py310-test-open-source
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-gh-linux-py310-test-open-source/.github/workflows/upload_artifacts.yml?" \
